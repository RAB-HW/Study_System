    ...
    public Docket adminCenterApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apiInfo(new ApiInfoBuilder()
                        ...
                        .contact(new Contact("HZB技术中心", "https://hzb-it.com", "541720500@qq.com"))
                        .version("v1.3.0")
                        .title("教务系统API文档")
                        .build())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.hzb.erp.api.pc"))
    ...
    public Docket studentCenterApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apiInfo(new ApiInfoBuilder()
                        ...
                        .build())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.hzb.erp.api.mobile.student"))
                .paths(PathSelectors.any())
                .build();
    }
    ...
    public Docket teacherCenterApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apiInfo(new ApiInfoBuilder()
                        ...
                        .build())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.hzb.erp.api.mobile.teacher"))
                .paths(PathSelectors.any())
                .build();
    }
